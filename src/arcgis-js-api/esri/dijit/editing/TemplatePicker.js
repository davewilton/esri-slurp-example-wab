        ...
        _processLegendResponse: function(a, b) {
            if (a && !(a instanceof Error)) g.forEach(b.indices, function(c) {
                ...
                this._legendSymbols[c] || (q = null, g.some(a.layers, function(a) {
                    ...
                    else m.defaultSymbol = a;
                    if ((l = a.url) && !a._fixed) a._fixed = 1, -1 === l.search(/https?\:/) && (a.url = n + l), p && -1 !== a.url.search(/https?\:/) && (a.url += (-1 < a.url.indexOf("?") ? "\x26" : "?") + "token\x3d" + p)
                })))
            }, this);
            else {
                var d;
            ...
            if (e) {
                ...
                if (0 < c.length) g.forEach(c,
                    function(c) {
                        ...
                        if (f) {
                            var k;
                            if (k = e.hasVisualVariables() && e.addBreak && e.infos && 1 === e.infos.length ? e.infos[0].symbol : e.getSymbol(f)) {
                                var m = null,
                                    l;
