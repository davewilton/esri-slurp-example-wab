//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "dojo/sniff", "dojo/dom-style", "dijit/_Widget", "dijit/_Templated", "dojox/gfx", "../../symbols/jsonUtils", "../../kernel"], function(k, l, p, q, v, m, r, s, t, u, w) {
    return k([r, s], {
        ...
        _draw: function(a, c, b, g, f) {
            if (c && "textsymbol" !== c.type) {
                a = t.createSurface(a, b, g);
                if (9 > q("ie")) {
                    var e = a.getEventSource();
                    m.set(e, "position", "relative");
                    m.set(e.parentNode, "position", "relative")
                }
                c = !this.legendOverride && this._getDrawingToolShape(c, f) || u.getShapeDescriptors(c);
                var h;
                try {
                    h = a.createShape(c.defaultShape).setFill(c.fill).setStroke(c.stroke)
                } catch (k) {
                    a.clear();
                    a.destroy();
                    return
                ...
                if (c > b || f > g) d = c / b > f / g, b = ((d ? b : g) - 5) / (d ? c : f), l.mixin(e, {
                    xx: b,
                    yy: b
                });
                h.applyTransform(e);
        ...
        _getDrawingToolShape: function(a, c) {
            var b;
            switch (c ? c.drawingTool || null : null) {
                ...
                case "esriFeatureEditToolFreehand":
                    b = "simplelinesymbol" === a.type || "cartographiclinesymbol" === a.type ? {
                        type: "path",
        ...
        _repaint: function(a) {
            a ? (a.getStroke && a.setStroke && a.setStroke(a.getStroke()), a.getFill && a.setFill && a.setFill(a.getFill()), a.children && l.isArray(a.children) && p.forEach(a.children, this._repaint, this)) : this._surface = this._draw(this._surfaceNode, this.symbol, this.surfaceWidth, this.surfaceHeight, this.template)
        },
        destroy: function() {
