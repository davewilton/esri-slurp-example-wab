//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/dom-class", "dojo/has", "dijit/_WidgetBase", "dojo/i18n!../../../nls/i18nBase", "dojo/i18n!../../../nls/i18nIso", "dijit/Dialog", "./ConceptPane", "../../../../../kernel"], function(d, b, e, l, f, m, g, h, k, n) {
    return d([f], {
        dialog: null,
        gxeDocument: null,
        initialValue: null,
        title: g.gemet.concept.dialogTitle,
        postCreate: function() {
        ...
        show: function() {
            var a = null,
                c = new k({
                    ...
                    onSelect: b.hitch(this, function(b) {
                        this.onSelect(b);
                        a && a.hide()
                    }),
