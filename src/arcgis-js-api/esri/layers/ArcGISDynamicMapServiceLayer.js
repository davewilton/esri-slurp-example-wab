    ...
    return u([z, A], {
        ...
        constructor: function(a, b, c) {
            ...
            if (a) {
                ...
                a.layerOption === s.LAYER_OPTION_SHOW && (this.visibleLayers = [].concat(a.layerIds), this.onVisibleLayersChange(this.visibleLayers))
            }
        ...
        _initLayer: function(a, b) {
            ...
            a.timeInfo &&
                (this.timeInfo = new B(a.timeInfo));
            this.loaded = !0;
            this.onLoad(this);
        ...
        getImageUrl: function(a, b, c, d) {
            ...
            e.layerDefs && (a = e.layerDefs, delete e.layerDefs,
                f.mixin(e, {
                    layerDefs: a
                }));
            var m = e.token = this._getToken();
            a = r.addProxy(g + w.objectToQuery(f.mixin({}, e, {
                f: "image"
            })));
            a.length > q.defaults.io.postLength || this.useMapImage ? this._jsonRequest = x({
                ...
                load: function(a) {
                    a = a.href;
                    m && (a += -1 === a.indexOf("?") ? "?token\x3d" + m : "\x26token\x3d" + m);
                    d(r.addProxy(a))
                },
                error: h
            }) : d(a)
        ...
        _setTime: function(a) {
            ...
            10.02 <= this.version && b && (!a &&
                !b.hasLiveData) && (this._params.time = "null,null")
        },
        setDPI: function(a, b) {
        ...
        setLayerTimeOptions: function(a, b) {
            ...
            this._params.layerTimeOptions = k._serializeTimeOptions(a);
            this._updateDynamicLayers();
            b || this.refresh(!0)
        },
        refresh: function(a) {
        ...
        setLayerDrawingOptions: function(a,
            b) {
        ...
        setDynamicLayerInfos: function(a, b) {
            a && 0 < a.length ? (this.dynamicLayerInfos = a, this.visibleLayers = k._getDefaultVisibleLayers(a), this.onVisibleLayersChange(this.visibleLayers)) : this.dynamicLayerInfos = this.layerDrawingOptions = null;
            this._updateDynamicLayers();
            b || this.refresh(!0)
        },
        createDynamicLayerInfosFromLayerInfos: function() {
            var a = [],
                b;
            l.forEach(this.layerInfos, function(c) {
                b = new D(c.toJson());
                b.source = new E({
                    mapLayerId: c.id
                });
        ...
        _updateDynamicLayers: function() {
            ...
            } else this._params.dynamicLayers ? (this._params.dynamicLayers = null, this._onDynamicLayersChange(null)) : this._params.dynamicLayers = null
        },
        ...
        exportMapImage: function(a, b) {
            ...
            this._exportMapImage(this._url.path + "/export", c,
                b)
        }
    })
});