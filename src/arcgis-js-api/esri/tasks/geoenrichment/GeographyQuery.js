...
define(["../../declare", "./GeographyQueryBase"], function(b, c) {
    return b("esri.tasks.geoenrichment.GeographyQuery", [c], {
        ...
        constructor: function(a) {
            a && (this.geographyLayerIDs = a.geographyLayerIDs || a.geographyLayers.split(";"), this.geographyIDs = a.geographyIDs, this.where = a.where || a.geographyQuery)
        },
        toJson: function() {
            var a = this.inherited(arguments);
            this.geographyLayerIDs && (a.geographyLayers = this.geographyLayerIDs.join(";"));
            this.geographyIDs && (a.geographyIDs =
                this.geographyIDs);
