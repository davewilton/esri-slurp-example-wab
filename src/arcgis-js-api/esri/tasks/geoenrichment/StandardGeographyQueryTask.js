//>>built
define(["../../declare", "dojo/_base/array", "dojo/_base/lang", "./taskHelper", "../FeatureSet", "./GeographyQueryBase", "./GeographyQuery", "./BatchGeographyQuery", "./SubGeographyQuery"], function(d, l, e, b, f, g, h, c, k) {
