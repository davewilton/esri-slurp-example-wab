//>>built
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/_base/array", "dojo/_base/Color", "dojo/has", "dojo/dom-construct", "dojo/dom-style", "../kernel", "../lang", "../sniff", "./_toolbar", "./_Box", "./_GraphicMover", "./_VertexEditor", "./TextEditor", "../symbols/SimpleMarkerSymbol", "../symbols/SimpleLineSymbol", "../symbols/TextSymbol", "../graphic"], function(v, w, m, l, k, f, n, t, x, F, u, G, y, z, A, B, C, h, c, D, E) {
    var d = w(y, {
        ...
        constructor: function(a, b) {
            ...
            var d = n("esri-touch") || n("esri-pointer");
            this._defaultOptions = m.mixin({
                vertexSymbol: new h(h.STYLE_CIRCLE, d ? 20 : 12, new c(c.STYLE_SOLID, new f([0, 0, 0, 0.5]), 1), new f([128, 128, 128])),
                ghostVertexSymbol: new h(h.STYLE_CIRCLE, d ? 18 : 10, new c(c.STYLE_SOLID, new f([0, 0, 0, 0.5]), 1), new f([255, 255, 255, 0.75])),
                ghostLineSymbol: new c(c.STYLE_DOT, new f([128, 128, 128]), 2),
                allowDeleteVertices: !0,
                allowAddVertices: !0,
                rotateHandleOffset: d ? 24 : 16,
                boxLineSymbol: new c(c.STYLE_DASH, new f([64, 64, 64]), 1),
                boxHandleSymbol: new h(h.STYLE_SQUARE, d ? 16 : 9, new c(c.STYLE_SOLID, new f([0, 0, 0, 0.5]), 1), new f([255, 255, 255, 0.75])),
                textAnchorSymbol: new h(h.STYLE_CIRCLE, 10, null, new f([255, 0, 0]))
            }, b || {})
        },
        activate: function(a, b, e) {
            ...
            (a & p) === p && (h = this._enableMove(b));
            p = (a & g) === g;
            c = (a & c) === c;
            if (p || c) n = this._enableBoxEditing(b, p, c);
            (a & e) === e && (k = this._enableVertexEditing(b));
            (a & f) === f && this._enableTextEditing(b);
        ...
        _prepareTextSymbolEditing: function(a, b) {
            if ("point" === a.geometry.type || "multipoint" === a.geometry.type) {
                var e = a.getLayer(),
                    c = e.renderer,
                    e = a.symbol || e._getSymbol(a);
                !e && (c.hasVisualVariables() && c.addBreak && c.infos && 1 === c.infos.length) && (e = c.infos[0].symbol || c.defaultSymbol);
                if (e && "textsymbol" === e.type) {
                    if ((b & d.SCALE) === d.SCALE || (b & d.ROTATE) === d.ROTATE || (b & d.EDIT_TEXT) === d.EDIT_TEXT) {
                        a.setSymbol(new D(e.toJson()));
                        var g = this;
                        if (this._textSymbolEditor) this._textSymbolEditor.createForm(a),
                            this._textSymbolEditor.show();
                        else if (this._options && this._options.textSymbolEditor) this._textSymbolEditor = this._options.textSymbolEditor, this._textSymbolEditor.on("symbol-change", function() {
                            g._boxEditor && g._boxEditor.refresh()
                        });
                        else {
                            var f;
                            ...
                            v(["../dijit/SymbolEditor"], function(b) {
                                g._textSymbolEditor = new b({
                                    graphic: a
                                }, f);
                                b = g._textSymbolEditor.domNode.parentNode.id;
                                x.set(g._textSymbolEditor.domNode, {
                                    position: "map_root" === b ? "absolute" : "relative",
                                    left: "map_root" === b ? g._map.width / 2 - 100 + "px" : "5px",
                                    top: "20px",
                                    "z-index": 50
                                });
                                g._textSymbolEditor.startup();
                                g._textSymbolEditor.createForm(a);
                                g._textSymbolEditor.show();
                                g._textSymbolEditor.on("symbol-change", function() {
                                    g._boxEditor && g._boxEditor.refresh()
                                })
                            })
                        }
        ...
        _enableMove: function(a) {
            ...
            switch (a.geometry.type) {
                ...
                case "polyline":
                case "polygon":
                    return this._graphicMover = new A(a, b, this, this._textAnchor), !0
            }
            return !1
        },
        ...
        _enableBoxEditing: function(a, b, e) {
            var d = this._map,
                c = a.geometry.type;
            return "polyline" === c || "polygon" === c || this._isTextPoint ? (this._boxEditor = new z(a,
                d, this, b, e, this._options.uniformScaling, this._isTextPoint), !0) : !1
        },
        _enableTextEditing: function(a) {
            return this._isTextPoint ? (this._textEditor = new C(a, this._map, this), l.connect(this._textEditor, "onEditStart", m.hitch(this, function() {
        ...
        _clear: function() {
            ...
            this._textAnchor &&
                (this._textAnchor.getLayer().remove(this._textAnchor), this._textAnchor = null);
            this._tool = 0;
            this._modified = !1
        },
        ...
        _mapExtentChangeHandler: function(a, b, e) {
            e && this._refreshMoveables()
        },
        ...
        _endOperation: function(a) {
            k.forEach(this._getAffectedTools(a),
                function(a) {
                    a.resume()
                })
        },
