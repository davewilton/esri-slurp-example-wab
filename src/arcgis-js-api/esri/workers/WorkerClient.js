//>>built
define(["dojo/Evented", "dojo/_base/declare", "dojo/Deferred", "dojo/_base/lang", "dojo/dom-construct", "dojo/request", "../sniff", "../kernel", "../urlUtils", "require"], function(k, n, h, e, s, p, q, t, f, r) {
    var l = window.Blob || window.webkitBlob || window.mozBlob,
        m = window.URL || window.webkitURL || window.mozURL;
    return n([k], {
        ...
        setWorker: function(a) {
            ...
            a = this._getUrl(a);
            var b = !f.hasSameOrigin(f.getAbsoluteUrl(a), location.href),
                d;
            ...
            if (b) {
                var g = this._getUrl("./mutableWorker", !0);
                try {
                    var e =
                        this._getRemoteText(g, !0);
                    d = new Worker(m.createObjectURL(new l([e], {
                        type: "text/javascript"
                    })))
                } catch (h) {
                    try {
                        g = f.getProxyUrl(g).path + "?" + encodeURI(g), d = new Worker(g), this._useProxy = !0
                    } catch (k) {
        ...
        addWorkerCallback: function(a,
            c) {
            var b;
            b = this._getUrl(a, !0);
            !1 === b ? (b = new h, b.reject({
                message: "Could not load text from " + a
            })) : (b = this.postMessage({
                action: "add-callback",
                url: b,
                cbName: c || "main"
        ...
        importScripts: function(a) {
            ...
            a = a.map(function(a) {
                a = this._getUrl(a, !0);
                this._useProxy && !f.hasSameOrigin(a, location.href) && (a = f.getProxyUrl(a).path + "?" + encodeURI(a));
                return a
            }, this);
            a = this.postMessage({
        ...
        _getUrl: function(a, c) {
            ...
            return c ? f.getAbsoluteUrl(b) : b
        },
        _getRemoteText: function(a, c) {
            var b = "";
            (a = this._getUrl(a)) && p.get(a, {
                sync: c,
                handleAs: "text",
                headers: {
                    "X-Requested-With": "",
        ...
        _startBlobWorker: function() {
            ...
            a || (a = this._getUrl("./mutableWorker"), a = new l(["if(!self._mutable){importScripts('" + a + "');}"], {
                type: "text/javascript"
            }), a = this._xdSource = m.createObjectURL(a));
            try {
                return new Worker(a)
            } catch (c) {
